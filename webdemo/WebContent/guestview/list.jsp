	...
	<c:forEach items="${requestScope.aList}" var="dto">
	  <tr>
             ...
             <c:if test="${dto.re_level>0}">
             	<img src="../guestview/images/level.gif" width="${15 * dto.re_level}" height = "0px"/>
             	<!-- 주소를 상대경로로 잡아줘야 한다. .. -> 상위 폴더 이동 -->
             <img src="../guestview/images/re.gif"/>
             </c:if>
            <%--  <a href="view.do?num=${dto.num}&pageNum=${pdto.currentPage}&searchKey=${pdto.searchKey}&searchWord=${pdto.searchWord}">${dto.subject}</a></td> --%>
		...
		<div>
			...
			<span><a href="list.do?pageNum=${pdto.startPage-pdto.blockPage}&searchKey=${pdto.searchKey}&searchWord=${pdto.searchWord}">이전</a></span>
			</c:if>
			...
			<span><a href="list.do?pageNum=${pdto.startPage+pdto.blockPage}&searchKey=${pdto.searchKey}&searchWord=${pdto.searchWord}">다음</a></span>
			</c:if>
